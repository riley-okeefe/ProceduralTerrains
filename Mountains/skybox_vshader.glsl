...
void main() {
    // make skybox big enough that we never cross it
    ...
    // calculate the texCoords based on the position of the vertices
    texCoords =  vec3(vposition.y, vposition.x, vposition.z);
