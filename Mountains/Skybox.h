...
public:
    Skybox(Vec3 _skyColor) {
        ...
        //const std::string skyList[] = { "front", "back", "bottom", "top", "right", "left" }; // additional skybox textures
        ...
        // load CUBE_MAP textures => the string name array already has them correctly sorted
        int tex_wh = 1024;
    ...
    void draw(Camera camera, float time) {
        ...
        // use GL_LEQUAL as the depth of the cubemap, will always be 1 and we don't want it to get discarded
