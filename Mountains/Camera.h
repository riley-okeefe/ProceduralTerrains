...
public:
    ...
    /* 
    yaw controls the side movement, yaw = 0 means we are looking forward,
    yaw = 90 means we are looking east, yaw = 270 means we are looking west
    pitch controls the up-down movement pitch = 0 means we are looking forward, 
    pitch = 90 means we are looking up, pitch = 270 means we are looking down
    */
    float yaw, pitch;
